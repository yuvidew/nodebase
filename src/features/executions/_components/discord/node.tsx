 ...
 * @component
 *
 * @param {NodeProps<DiscordNodeType>} props - The props provided by React Flow for this node.
 * @param {string} props.id - Unique identifier for the node.
 * @param {DiscordNodeData} props.data - Data associated with this Discord node, including endpoint, method, and body.
 *
